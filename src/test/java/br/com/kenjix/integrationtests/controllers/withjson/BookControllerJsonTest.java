...
import br.com.kenjix.integrationtests.dto.wrappers.json.WrapperBookDTO;
...
class BookControllerJsonTest extends AbstractIntegrationTest {
    ...
    void findAllTest() throws JsonProcessingException {
        ...
        assertEquals(123.0, bookOne.getPrice());

        BookDTO foundBookSeven = books.get(2);
        ...
        assertEquals("Os 11 segredos de líderes de TI altamente influentes", foundBookSeven.getTitle());
        assertEquals("Marc J. Schiller", foundBookSeven.getAuthor());
        assertEquals(45.0, foundBookSeven.getPrice());
    }
