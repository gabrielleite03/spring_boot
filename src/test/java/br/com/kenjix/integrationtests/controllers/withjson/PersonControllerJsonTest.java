...
import br.com.kenjix.integrationtests.dto.AccountCredentialsDTO;
import br.com.kenjix.integrationtests.dto.PersonDTO;
import br.com.kenjix.integrationtests.dto.TokenDTO;
import br.com.kenjix.integrationtests.dto.wrappers.json.WrapperPersonDTO;
...
class PersonControllerJsonTest extends AbstractIntegrationTest {
    ...
    @Test
    @Order(6)
    // @Disabled("Diferenças nos objetos passados")
    void findAllTest() throws JsonProcessingException {
        ...
        assertEquals("Adams", personOne.getFirstName());
        assertEquals("Carlino", personOne.getLastName());
        assertEquals("204 Mallard Hill", personOne.getAddress());
        ...
        assertEquals("Adiana", personFour.getFirstName());
        assertEquals("Yoseloff", personFour.getLastName());
        assertEquals("9 Bultman Avenue", personFour.getAddress());
    ...
    private void mockPerson() {
        ...
        person.setProfileUrl("https://pub.kenjix.com.br/meus-cursos");
        person.setPhotoUrl("https://pub.kenjix.com.br/meus-cursos");
    }
}