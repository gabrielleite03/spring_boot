package br.com.kenjix.integrationtests.controllers.withyaml;

import br.com.kenjix.config.TestConfigs;
import br.com.kenjix.integrationtests.controllers.withyaml.mapper.YAMLMapper;
...
import br.com.kenjix.integrationtests.dto.wrappers.xmlandyaml.PagedModelBook;
...
class BookControllerYamlTest extends AbstractIntegrationTest {
    ...
    void findAllTest() throws JsonProcessingException {
        ...
        assertEquals(45, bookOne.getPrice());

        BookDTO foundBookSeven = content.get(1);
        ...
        assertEquals("Domain Driven Design", foundBookSeven.getTitle());
        assertEquals("Eric Evans", foundBookSeven.getAuthor());
        assertEquals(92, foundBookSeven.getPrice());
    }
